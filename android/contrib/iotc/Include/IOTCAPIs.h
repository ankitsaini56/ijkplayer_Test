...
3.1.10.6	|Ethan Tsai	       |2019-02-11     |o Mark IOTC_Lan_Search2_Ex as deprecated
3.1.10.6	|Ethan Tsai	       |2019-02-11	   |o Mark IOTC_Connect_ByUID as deprecated
3.1.10.6    |Ethan Tsai		   |2019-02-11	   |o Mark IOTC_Session_Check, IOTC_Session_Check_ByCallBackFn as deprecated
3.1.10.6    |Ethan Tsai        |2019-02-11     |o Mark IOTC_Session_Read_Check_Lost as deprecated
3.1.10.9    |Ewan Chen         |2019-11-15     |o Mark IOTC_Set_Log_Path as deprecated
 */
...
#define MAX_DEFAULT_IOTC_SESSION_NUMBER				128
#endif // #ifdef __linux__  __APPLE__
 ...
 * 				  If you want to add security,please replace it with IOTC_Device_LoginEx.
 * 				  Otherwise replace it with IOTC_Device_Login.
 *
 */
 ...
 *
 */
P2PAPI_API_DEPRECATED int  IOTC_Connect_ByUID(const char *cszUID);
 ...
 */
P2PAPI_API_DEPRECATED int  IOTC_Session_Read_Check_Lost(int nIOTCSessionID, char *abBuf, int nMaxBufSize,unsigned int nTimeout, unsigned short *pnPacketSN,char *pbFlagLost, unsigned char nIOTCChannelID);
 ...
 */
P2PAPI_API_DEPRECATED int  IOTC_Session_Check(int nIOTCSessionID, struct st_SInfo *psSessionInfo);
 ...
 * 				Please replace it with IOTC_Session_Check_Ex.
 */
P2PAPI_API_DEPRECATED int IOTC_Session_Check_ByCallBackFn(int nIOTCSessionID, sessionStatusCB pfxSessionStatusFn);
 ...
 *
 */
P2PAPI_API_DEPRECATED void IOTC_Set_Log_Path(char *path, int nMaxSize);
 ...
 *            (3) This API can only be used in client side
 */
P2PAPI_API_DEPRECATED int IOTC_Lan_Search2_Ex(struct st_LanSearchInfo2 *psLanSearchInfo2, int nArrayLen, int nWaitTimeMs, int nSendIntervalMs);
...
*            (3) This API has been deprecated and might be removed in the next version, please replace it with RDT or IOTC_Session_Write
*/
...
*				 to get more IOTC channel IDs and then specifying those IOTC channel IDs
*				 in this function according to the purpose defined by the user. <br><br>
*            (2) This API has been deprecated and might be removed in the next version, please replace it with RDT or IOTC_Session_Write
*
**/
...
**/
P2PAPI_API int IOTC_DebugTool_Initialize(char *pwd, DebugToolMode mode);

/**
* \brief Device/Client can collect sdk information with this api
*
...
*          Client can connect to device which DebugTool is turn on and collect sdk information in LAN mode.
*
