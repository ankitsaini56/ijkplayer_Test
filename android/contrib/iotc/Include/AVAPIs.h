...
3.1.10.6    |Ethan Tsai        |2019-02-11     |o Mark avServStart2, avServStart3 as deprecated
3.1.10.6    |Ethan Tsai        |2019-02-11     |o Mark avClientStart, avClientStart2 as deprecated
3.1.10.9    |Ewan Chen         |2019-11-15     |o Mark AV_Set_Log_Path as deprecated
 */
 ...
 *
 */
AVAPI_API_DEPRECATED int avServStart2(int nIOTCSessionID, authFn pfxAuthFn, unsigned int nTimeout, unsigned int nServType, unsigned char nIOTCChannelID);
 ...
 *
 */
AVAPI_API_DEPRECATED int avServStart3(int nIOTCSessionID, authFn pfxAuthFn, unsigned int nTimeout, unsigned int nServType, unsigned char nIOTCChannelID, int *pnResend);
 ...
 *
 */
AVAPI_API_DEPRECATED int avClientStart(int nIOTCSessionID, const char *cszViewAccount, const char *cszViewPassword,
 ...
 *
 */
AVAPI_API_DEPRECATED int avClientStart2(int nIOTCSessionID, const char *cszViewAccount, const char *cszViewPassword,
 ...
 */
AVAPI_API_DEPRECATED int avCheckAudioBuf(int nAVChannelID);
 ...
 *
 */
AVAPI_API_DEPRECATED void AV_Set_Log_Path(char *path, int nMaxSize);
 ...
 *          - #AV_ER_CLIENT_NOT_SUPPORT An AV client uses this function
 *          - #AV_ER_NOT_INITIALIZED AV module is not initialized yet
 *          - #AV_ER_DASA_CLEAN_BUFFER Do Clean Buffer
 *
