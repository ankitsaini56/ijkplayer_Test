...
**/
P2PAPI_API int IOTC_Device_Login_By_Nebula(NebulaDeviceCtx* device_ctx);
...
**/
P2PAPI_API int IOTC_Device_Listen_By_Nebula(NebulaDeviceCtx *device_ctx, unsigned int timeout_msec);
